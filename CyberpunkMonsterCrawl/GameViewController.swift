...
final class GameViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // `FloatingThumbstickNode` drives movement from the left region
        // while the HUD's bottom-right `HUDPulseButton` sits under the other
        // thumb - a control specifically meant to be pressed *while* the
        // first thumb is moving. Without this line
